...
import { getMintPriceNanoton, registerDebugHelpers, getCollectionAddress, buildMintPayload } from '../lib/ton';
...
export function NFTMinter() {
  ...
  if (state === 'success') {
    return <SuccessSheet txHash={txHash} onReset={handleReset} />;
  }
